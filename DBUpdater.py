...
class DBUpdater:
    def __init__(self):
        """생성자: MariDB연결 및 종목코드 딕셔너리 생성"""
        self.conn=pymysql.connect(host='localhost',user='root',password='wkrwjs71014600^*',db='investar',charset='utf8')
    ...
    def read_naver(self, code, company, pages_to_fetch):
        ...
        try:
            ...
            for page in range(1,pages+1):
                ...
                response_page=requests.get(pg_url,headers={'User-agent': 'Mozilla/5.0'}).text
    ...
    def replace_into_db(self,df,num,code,company):
        """네이버 금웅에서 읽어온 주식 시세를 DB 에 REPLACE"""
        with self.conn.cursor() as curs:
            for r in df.itertuples():
                print("{} {} {} {} {} {} {} {}".format(code,r.date,r.open,r.high,r.low,r.close,r.diff,r.volume))
